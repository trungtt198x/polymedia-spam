  ...
  return (
    <div id="page-about">
      <div id="home-content">
        ...
        <p>The more transactions you send, the more SPAM you earn.</p>
        ...
        <p>
          This was the original landing page for SPAM. The functionality is kept
          around so miners can claim their counters.
        </p>
        ...
        <div className="tight">
          ...
          <p>
            ...
            register it during day 2
          </p>
          <p>▸ You can mint SPAM anytime from day 3</p>
        </div>
        <p className="text-red">
          If you don't register a counter, it cannot mint SPAM!
        </p>
        ...
        <p>
          <LinkExternal
            follow={true}
            href="https://github.com/trungtt198x/polymedia-spam/blob/main/README.md"
          >
            Read the docs
          </LinkExternal>
        </p>
