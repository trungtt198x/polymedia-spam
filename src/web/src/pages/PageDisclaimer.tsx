...
export const PageDisclaimer: React.FC = () =>
{
    ...
    <p>
        The only cost to mine SPAM is Iota transaction fees. I don't make any money from it. Therefore I can't refund your transaction fees if there is a bug that prevents you from claiming your SPAM.
    </p>
    <p>
    ...
    <div className="tight">
        ...
        <p>2. <span className="text-red">Only use your miner wallet for spamming</span>: do not send other transactions from the miner address using a Iota wallet.</p>
        <p>3. <span className="text-red">Stop the miner before withdrawing</span>: if you load the miner secret key into a Iota wallet to withdraw your SPAM, you must stop the miner first.</p>
    </div>
    <p>
