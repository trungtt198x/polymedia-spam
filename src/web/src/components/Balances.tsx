...
export const Balances: React.FC<{ balances: UserBalances; isLoading: boolean }> = ({ balances, isLoading }) => {
    if (!balances) {
        return null;
    }
    return (
...
export const BalanceIOTA: React.FC<{ balances: UserBalances; isLoading: boolean }> = ({ balances, isLoading }) => {
    if (!balances) {
      return null;
    }
    return (
